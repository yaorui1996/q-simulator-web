...
<template>
    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M24.5 33L35 15" stroke="currentColor" stroke-width="3" stroke-linecap="round"
...
svg {
    ...
    height: 32px;
    border-radius: 4px;
    color: v-bind("display == Display.Grabbed ? 'rgb(192, 132, 252)' : inCircuitDropzone ? 'rgb(229, 229, 229)' : 'rgb(168, 85, 247)'");
...
.value {
    ...
    color: v-bind("display == Display.Grabbed ? 'rgb(255, 255, 255)' : value == '0' ? 'rgb(239, 68, 68)' : 'rgb(59, 130, 246)'");
